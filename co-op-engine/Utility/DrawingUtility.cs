...
namespace co_op_engine.Utility
{
    public static class DrawingUtility
    {
        ...
        public static Vector2 EaseOutQuart(Vector2 start, Vector2 change, float duration, float currentTime)
        {
            return new Vector2(
                x: EaseOutQuart(start.X, change.X, duration, currentTime),
                y: EaseOutQuart(start.Y, change.Y, duration, currentTime)
            );
        }

        public static float EaseOutQuart(float startValue, float changeInValue, float duration, float currentTime)
        {
        ...
        public static Vector2 EaseInQuart(Vector2 start, Vector2 change, float duration, float currentTime)
        {
            return new Vector2(
                x: EaseInQuart(start.X, change.X, duration, currentTime),
                y: EaseInQuart(start.Y, change.Y, duration, currentTime)
            );
        }

        public static float EaseInQuart(float startValue, float changeInValue, float duration, float currentTime)
        {
            currentTime /= duration;
