...
namespace co_op_engine.GameRules
{
    class SpawnerBase
    {
        ...
        //internal:
        //contains an equation to direct spawning (thinking area under curve as inverse max time, most likely sinus in nature combined with other spawners to have harmonic spawns
